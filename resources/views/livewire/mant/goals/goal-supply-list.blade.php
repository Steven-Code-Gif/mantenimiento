<article class="shadow-lg border border-gray-100 rounded p-2">
    <div class="">
        <div class="">
            <h1 class="text-xl font-bold text-gray-500">{{ __("listado de insumos") }}</h1>
            <hr class="mt-2 mb-3">
            ...
            @foreach ($supplies as $replacement)
                <div class="bg-green-100 border-t border-b border-green-500 text-green-700 px-1 py-1" role="alert">
                    ...
                    <p class="text-xs flex justify-between items-center">{{ __("cantidad") }}:{{$replacement->pivot->quantity}}
