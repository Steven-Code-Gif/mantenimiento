<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-xl sm:rounded-lg p-6 my-8 max-w-6xl mx-auto">
            <h1 class="text-2xl text-center text-gray-500 uppercase font-bold">{{ __('Lista de Insumos') }}</h1>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="flex items-center justify-between gap-3">
                        {{-- <a href="{{ route('Supplies.show',$supply->id)}}" title="{{ __('view daitl of supply ').$supply->name }}" ><i class="text-blue-500 fa-solid fa-eye"></i></a> --}}
                        <a href="{{ route('supplies.edit',$supply->id)}}" title="{{ __('Editar Insumo').$supply->name }}" ><i class="icono text-green-500 fa-solid fa-pen-to-square"></i></a>
    ...
    $('.form-delete').submit(function(e){
        e.preventDefault();
        Swal.fire({
  title: 'Esta seguro de querer eliminar Insumo?',
