        ...
        <div class="bg-white shadow-xl sm:rounded-lg p-6 my-8 max-w-7xl mx-auto">
            <div class="card">
                <div class="card-body font-normal">
                    <h1 class="text-lg text-center text-gray-500 uppercase font-bold">{{ __('linea de tiempo')." : ".$plan->name }}</h1>
                    <h2 class="text-sm text-center text-gray-400 uppercase font-bold">{{ $plan->start->format('d-m-Y h:i A') }}</h2>
                    ...
                    <table id="timeline" class="text-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="hidden">{{ __("posicion") }}</th>
                                <th class="hidden">{{ __("secuencia") }}</th>
                                <th class="text-center">{{ __("tiempo") }}</th>
                                <th>{{ __("inicio") }}</th>
                                <th>{{ __("fin") }}</th>
                                <th>{{ __("tarea") }}</th>
                                <th>{{ __("miembros") }}</th>
