<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-xl sm:rounded-lg p-6 my-8 max-w-7xl mx-auto">
            ...
            <h2 class="text-xl text-center text-gray-400 uppercase font-bold font-mono">
                {{ __('añadir recursos al objetivo de mantenimiento') }}</h2>
            <div class="flex items-center justify-end mb-3">
                <a href="{{ URL::previous() }}" class="px-3 py-2 bg-green-500 text-white rounded-lg hover:bg-green-400">
            ...
            <table id="goal" class="">
                <thead>
                    <tr>
                        ...
                        <th class="capitalize">{{ __('recursos') }}</th>
                    ...
                    @foreach ($goals as $goal)
                        <tr class="odd:bg-slate-100">
                            ...
                            <td class="text-center">
                                <a class="mx-2" href="{{ route('goals.replacements', $goal->id) }}"
                                    title="{{ __('agregar recursos') . ' : ' . $goal->task }}"><i
                                        class="icono text-green-500 fa-solid fa-toolbox"></i></a>

                                <a href="{{ route('goals.positions', $goal->id) }}"
                                    title="{{ __('posición de meta') . ' : ' . $goal->task }}"><i
                                    class="icono text-red-600 fa-solid fa-list-ol"></i>
                                </a>
                            </td>
                        </tr>
                    @endforeach
