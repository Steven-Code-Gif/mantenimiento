    ...
    <div class="card my-6 mx-auto max-w-md">
        <div class="card-body">
            <div class="w-full bg-gray-200 rounded p-4 mx-auto mb-4">
                ...
                <p class="text-gray-600 italic text-sm">Ubicacion: {{$equipment->location()}}</p>
                ...
                <p class="text-gray-600 italic text-sm">Tareas por Equipo: {{$equipment->prototype->protocols->count()}}</p>
                <p class="text-gray-600 italic text-sm">Tiempo Estimado: {{$equipment->prototype->protocols->sum('duration')}} hrs.</p>
                <p class="text-gray-600 italic text-sm">Trabajadores para Tareas: {{$equipment->prototype->protocols->sum('workers')}}</p>
            </div>
