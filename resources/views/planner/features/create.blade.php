        ...
        <form action="{{ route('features.store') }}" method="POST" class="max-w-2xl mx-auto rounded-lg shadow-lg">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="grid  md:grid-cols-2 gap-3">
                        ...
                        <div class="mb-2 md:mb-4">
                            ...
                            <x-jet-input type="text" name="unit" class="w-full "
                                placeholder="{{ __('unidad') }}" value="{{ old('unit', $feature->unit) }}" />
                    ...
                    <div class="grid md:grid-cols-2 gap-3">
                        <div class="w-full">
                            ...
                            <x-jet-input type="text" name="symbol" class="w-full "
                                placeholder="{{ __('simbolo') }}" value="{{ old('symbol', $feature->symbol) }}" />
                            <x-jet-input-error for="symbol" />
                        </div>
                        <div class="w-full text-xs">
                            <x-jet-label class="italic my-2 capitalize" value="{{ __('Numerico') }}" for="isNumeric" />
                    ...
                    <textarea name="description" class="w-full my-2 rounded" placeholder="{{ __('descripcion') }}">{{ old('description', $feature->description) }}</textarea>
                    <div class="my-2">
                        <div>
