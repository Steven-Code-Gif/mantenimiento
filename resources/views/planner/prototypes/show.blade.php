                    ...
                    @foreach ($prototype->protocols as $protocol)
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 font-semibold text-xs">Seguridad : {{ $protocol->security }}
                                </p>
                                </p>
                                <p class="text-gray-600 font-semibold text-xs">Condición : {{ $protocol->conditions }}
                                </p>
                                <p class="text-gray-600 font-bold text-sm">Frecuencia : {{ $protocol->frecuency }}
                                    veces al
                                    año</p>
                                <p class="text-gray-600 font-bold text-sm">Duración : {{ $protocol->duration }} horas
                                </p>
