<x-app-layout>
    <div class="container my-4">
        <form action="{{ route('prototypes.store') }}" method="POST"
            class="max-w-2xl mx-auto rounded-lg 
        shadow-lg">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 p-3">
                        <div class="mb-4">
                            <x-jet-label class="italic capitalize" value="{{ __('image') }}" for="name" />
                        ...
                        <div class="mb-4">
                            <x-jet-label class="italic my-2 capitalize font-bold" value="{{ __('name of prototype') }}"
                                for="name" />
                            <x-jet-input type="text" name="name" class="w-full mb-1"
