                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 p-3 border shadow-sm">
                        ...
                        <div class="mb-4 bg-slate-100 rounded p-3">
                            <x-jet-label class="italic capitalize font-bold" value="{{ __('nombre de prototipo') }}"
                                for="name" />
                            <x-jet-input type="text" name="name" class="w-full "
                                placeholder="{{ __('nombre') }}" value="{{ old('name', $prototype->name) }}" />
                            <x-jet-input-error for="name" />

                            <x-jet-label class="italic capitalize font-bold" value="{{ __('caracteristicas') }}"
                                for="name" />
                            ...
                            <x-jet-label class="italic capitalize font-bold"
                                value="{{ __('descripcion de prototipo') }}" for="name" />
