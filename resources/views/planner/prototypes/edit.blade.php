                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 p-3">
                        <div class="mb-4 bg-slate-200 p-2 rounded">
                            <x-jet-label class="italic my-2 capitalize text-center font-bold" value="{{ __('imagen de prototipo') }}" for="name" />
                        ...
                        <div class="mb-4 bg-slate-100 rounded p-3">
                            <x-jet-label class="italic capitalize font-bold" value="{{ __('nombre del prototipo') }}" for="name" />
                            <x-jet-input type="text" name="name" class="w-full "
                                placeholder="{{ __('input name') }}" value="{{ old('name', $prototype->name) }}" />
                            <x-jet-input-error for="name" />

                            <x-jet-label class="italic capitalize font-bold" value="{{ __('caracteristica') }}" for="name" />
                            <x-jet-input type="text" name="cha_1" class="w-full mb-1"
                                placeholder="{{ __('caracteristica 1') }}" value="{{ old('cha_1', $prototype->cha_1) }}" />
                            <x-jet-input type="text" name="cha_2" class="w-full mb-1 "
                                placeholder="{{ __('caracteristica 2') }}" value="{{ old('cha_2', $prototype->cha_2) }}" />
                            <x-jet-input type="text" name="cha_3" class="w-full mb-1 "
                                placeholder="{{ __('caracteristica 3') }}" value="{{ old('cha_3', $prototype->cha_3) }}" />
                            <x-jet-input type="text" name="cha_4" class="w-full mb-1 "
                                placeholder="{{ __('caracteristica 4') }}" value="{{ old('cha_4', $prototype->cha_4) }}" />
                                <x-jet-label class="italic capitalize font-bold" value="{{ __('descripcion del prototipo') }}" for="name" />
