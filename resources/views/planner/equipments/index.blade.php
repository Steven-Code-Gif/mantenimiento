                        ...
                        <tr class="odd:bg-slate-100">
                            ...
                            <td class="grid grid-cols-3 gap-4 items-center justify-between">
                                <a href="{{ route('equipments.show', $equipment->id) }}"
                                    title="{{ __('ver detalle de equipo')." : " . $equipment->task }}"><i
