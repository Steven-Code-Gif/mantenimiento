                        ...
                        <tr>
                            ...
                            <td class="grid grid-cols-3 gap-4 items-center justify-between">
                                ...
                                <a href="{{ route('equipments.addFeatures', $equipment->id) }}"
                                    title="{{ __('add features to ') . $equipment->task }}">
                                    <i class="icono text-green-500 fa-solid fa-closed-captioning"></i></a>

                                <a href="{{ route('equipments.addValues', $equipment->id) }}"
                                    title="{{ __('add features to ') . $equipment->task }}">
                                    <i class="icono text-red-500 fa-solid fa-keyboard"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
