                        ...
                        <tr class="odd:bg-slate-100">
                            <td width="15%">
                                <div  class="text-center">
                                    <p class="text-gray-700 font-bold text-sm">{{ __("número de prototipos con este protocolo") }}:</p>
                            ...
                            <td class="text-center">
                                <a class="" href="{{ route('protocols.edit', $protocol->id) }}"
                                    title="{{ __('editar protocolo') . $protocol->task }}"><i
    ...
    @push('script')
        <script>
            ...
            $('.form-delete').submit(function(e) {
                ...
                Swal.fire({
                    title: 'Está seguro de querer eliminar protocolo?',
