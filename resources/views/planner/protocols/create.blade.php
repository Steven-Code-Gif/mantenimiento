                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-3 gap-2 text-xs p-4 border shadow-sm my-2 bg-slate-50">
                        ...
                        <div class="col-span-3 grid grid-cols-4 gap-2">
                            ...
                            <div class="mb-4">
                                <x-jet-label class="italic my-2 capitalize" value="{{ __('permiso') }}"
                                    for="name" />
                            ...
                            <div class="mb-4">
                                <x-jet-label class="italic my-2 capitalize" value="{{ __('seguridad') }}"
                                    for="name" />
                            ...
                            <div class="mb-4">
                                <x-jet-label class="italic my-2 capitalize" value="{{ __('condicion') }}"
                                    for="conditions" />
