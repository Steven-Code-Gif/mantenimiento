                    ...
                    <div class="grid grid-cols-3 gap-2 text-xs">
                        <div class="mb-4 col-span-3">
                            ...
                            <select name="prototype_id" class="w-full rounded-lg">
                                @foreach ($prototype as $prototype)
                        ...
                        <div class="mb-4">
                            <x-jet-label class="italic my-2 capitalize" value="{{ __('Especialidad') }}" for="name" />
                        ...
                        <div class="mb-4">
                            <x-jet-label class="italic my-2 capitalize" value="{{ __('Tarea') }}" for="name" />
                            <x-jet-input type="text" name="task" class="w-full "
                                placeholder="{{ __('tarea') }}" value="{{ old('name', $protocol->task) }}" />
                        ...
                        <div class="mb-4 col-span-3 md:col-span-2">
                            ...
                            <textarea name="detail" class="w-full rounded " placeholder="{{ __('detalle') }}">
                                {{ old('detail', $protocol->detail) }} </textarea>
                        ...
                        <div class="mb-4 grid grid-cols-3 gap-2">
                            ...
                            <div>
                                <x-jet-label class="italic my-2 capitalize" value="{{ __('Duración') }}"
                                    for="duration" />
                            ...
                            <div>
                                <x-jet-label class="italic my-2 capitalize" value="{{ __('Posición') }}"
                                    for="position" />
                        ...
                        <div class="mb-4">
                            <x-jet-label class="italic my-2 capitalize" value="{{ __('Condición') }}" for="name" />
