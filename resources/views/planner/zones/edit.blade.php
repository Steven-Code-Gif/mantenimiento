<x-app-layout>
    <div class="container my-4">
        <form action="{{ route('zones.update',$zone->id) }}" method="POST" class="max-w-lg mx-auto rounded-lg shadow-lg">
            @csrf
            @method('PUT')
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <div class="mb-4">
                            ...
                            <x-jet-input type="text" name="name" class="w-full "
                                placeholder="{{ __('nombre') }}" value="{{ old('name', $zone->name) }}" />
                            <x-jet-input-error for="name" />
                            <hr class="mb-4">
                            <a type="button" href="{{ route('zones.index') }}"
