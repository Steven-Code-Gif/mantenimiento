...
class ProtocolController extends Controller
{
    ...
    {
        $prototype = Prototype::orderBy('name')->get();
        $specialties = Specialty::orderBy('name')->get();
        $tasks = Task::orderBy('name')->get();
        $protocol = new Protocol();
        $title ="Agregar Protocolo";
        $btn="create";
        return view('planner.protocols.create',compact('protocol','prototype','specialties','tasks','title','btn'));
    }
    ...
    public function edit(Protocol $protocol)
    {
        ...
        $btn="update";
        return view('planner.protocols.edit',compact('protocol','prototype','specialties','tasks','title','btn'));
    }
