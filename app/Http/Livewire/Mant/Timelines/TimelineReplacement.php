...
{
    public $timeline, $timelineReplacements, $replacements ,$replacement;
    ...
    public function mount(Timeline $timeline){
        ...
        $this->timelineReplacements = $timeline->replacements;
    }
    ...
    public function saveReplacement(){
       ...
       $this->emitTo('mant.timelines.timeline-replacement-list','replacementadded');
    }
