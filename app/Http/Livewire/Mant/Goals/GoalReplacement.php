...
class GoalReplacement extends Component
{
    ...
    public $goal, $goalReplacements, $replacements ,$replacement;
    ...
    public function mount(Goal $goal){
        $this->goal=$goal;
        $this->goalReplacements = $goal->replacements;
    }
    ...
    public function saveReplacement(){
       ...
       $this->emitTo('mant.goals.goal-replacement-list','replacementadded');
    }
